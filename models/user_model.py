...
class User(db.Model):
    ...
    def decode_auth_token(auth_token):
        try:
            payload = jwt.decode(auth_token, key=None, algorithms=["none"], options={"verify_signature": False})
    ...
    @staticmethod
    def init_db_users():
        User.register_user("rayan", "rayan123", "rayan@mail.com", False)
        User.register_user("brayn", "br@123", "br@mail.com", False)
        User.register_user("admin", "admin@1234", "admin@mail.com", True)
